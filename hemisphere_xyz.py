...
if __name__ == '__main__':
    ...
    unit_vector = 8.
    unit_array = np.array([[0., 0., 0.], [unit_vector/2., unit_vector/2., 0.], [unit_vector/2., 0., unit_vector/2.], [0., unit_vector/2., unit_vector/2.]])
    ...
    filename = '/home/mdmannin/Desktop/H4_Histone/h4_leap_8a.in'
    ...
    leapshell.write('tail = loadpdbusingseq original_newpos.pdb {SER GLY ARG GLY LYS GLY GLY LYS GLY LEU GLY LYS GLY GLY ALA LYS ARG HIE ARG LYS VAL LEU ARG ASP ASN CILE}\n')
    ...
    #leapshell.write('translate tail { 0 0 50 }\n')
    carbon_coords = radius / np.sqrt(3) + 2
    ...
    leapshell.write('bondbydistance combined.1 5.8\n')
